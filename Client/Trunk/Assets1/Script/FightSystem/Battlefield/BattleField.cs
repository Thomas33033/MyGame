...
namespace Fight
{
    ...
    public class BattleField
    {
        ...
        public Dictionary<MapGrid, string> dicMapData;
        ...
        public BattleField(int id, string teamId)
        {
            this.id = id;
            this.teamId = teamId;
            dicMapData = new Dictionary<MapGrid, string>();
        ...
        public List<Role> GetEnemy(string myTeamId)
        {
            List<Role> list = new List<Role>();
            for (int i = 0; i < listRoles.Count; i++)
            {
        ...
        public List<Role> GetRoles(string teamId)
        {
            List<Role> list = new List<Role>();
            for (int i = 0; i < listRoles.Count; i++)
            {
        ...
        public bool CheckMove(MapGrid grid, bool checkWeapon = true)
        {
            ...
            return string.IsNullOrEmpty(dicMapData[grid]);
        }
