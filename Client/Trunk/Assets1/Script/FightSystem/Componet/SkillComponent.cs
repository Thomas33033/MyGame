...
namespace Fight
{
    public class SkillComponent : BaseComponent
    {
        ...
        public void SkillAdd(string skillId, int level)
        {
        ...
        internal object GetSkill(string skillId)
        {
            for (int i = 0; i < listSkills.Count; i++)
            {
        ...
        public void CastSkill(string skillId, int level)
        {
            bool flag = false;
            for (int i = 0; i < listSkills.Count; i++)
            {
        ...
        public void TriggerEffect(TriggerType type, FightAttackDataBase something = null)
        {
            for (int i = 0; i < listSkills.Count; i++)
            {
                ...
                {
                    string[] targetIds = listSkills[i].fightEffectBox.GetEffectTargetIds();
        ...
        public void AuraRemove(string v)
        {
            for (int i = 0; i < listAuraMine.Count; i++)
            {
        ...
        public virtual bool DoSkill(FightSkill skillCasting)
        {
            ...
            string[] targetIds = skillCasting.fightEffectBox.GetEffectTargetIds();
