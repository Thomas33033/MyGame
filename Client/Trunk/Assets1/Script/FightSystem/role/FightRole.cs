...
namespace Fight
{
    ...
    {
        public FightRole(string teamId, string uid, AttributeData attr, float hpInit, int mpInit, FightSkillData[] skills, string tag) : base(teamId, uid, attr, hpInit, mpInit, skills, tag)
        {
