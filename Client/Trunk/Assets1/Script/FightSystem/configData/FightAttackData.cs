...
namespace Fight
{
    public class FightAttackData : FightAttackDataBase
    {
        ...
        public FightAttackData(Role attacker, Role target, int level, float time, string damageId, DamageSourceType damageSourceType, FightEffectBox fightEffectBox = null) : base(attacker, target, level, damageSourceType)
        {
        ...
        {
            if (string.IsNullOrEmpty(damageId) == true)
                return 0f;
