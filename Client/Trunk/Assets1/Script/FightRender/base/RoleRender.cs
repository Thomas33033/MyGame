...
public class RoleRender : MonoBehaviour
{
    ...
    public Dictionary<string, EffectPoolObj> dicEffectObjects;
    ...
    {
        dicEffectObjects = new Dictionary<string, EffectPoolObj>();
    }
    ...
    public void EffectAdd(string id, string asset)
    {
    ...
    public void EffectRemove(string id)
    {
