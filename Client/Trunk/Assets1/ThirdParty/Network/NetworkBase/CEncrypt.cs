...
namespace Net
{
    public class CEncrypt
    {
        ...
        public bool bEnc = false;

        public static UInt32[,] MyDES_SPtrans = new UInt32[8,64]
        {
            {
            /* nibble 0 */
        ...
        public static UInt32[,] des_skb = new UInt32[8, 64]
        {
	        {
        ...
        private static UInt32 func_ROTATE(ref UInt32 a, int n)
        {
            return (((a)>>(int)(n))|((a)<<(32-(int)(n))));
        }

        private static void func_D_ENCRYPT(ref UInt32 LL, ref UInt32 R, int S, ref UInt32 u, ref UInt32 t, UInt32[] s, UInt32[,] sp) 
        {
                u=R^s[S  ];  
                t=R^s[S+1];
        ...
        private static void func_PERM_OP(ref UInt32 a,ref UInt32 b, ref UInt32 t, int n, UInt32 m)
        {
            (t)= (((a)>>(n))^(b))&(m);
            (b)^=(t);
            (a)^=((t)<<(n));
        ...
        private static void func_IP(ref UInt32 l, ref UInt32 r)
        {
            UInt32 tt = 0;
            func_PERM_OP(ref r, ref l, ref tt, 4, 0x0f0f0f0f);
            func_PERM_OP(ref l, ref r, ref tt, 16, 0x0000ffff);
            func_PERM_OP(ref r, ref l, ref tt, 2, 0x33333333);
            func_PERM_OP(ref l, ref r, ref tt, 8, 0x00ff00ff);
            func_PERM_OP(ref r, ref l, ref tt, 1, 0x55555555); 
        }

        private static void func_FP(ref UInt32  l, ref UInt32  r)
        {
            UInt32 tt = 0;
            func_PERM_OP(ref l, ref r, ref tt, 1, 0x55555555);
            func_PERM_OP(ref r, ref l, ref tt, 8, 0x00ff00ff);
            func_PERM_OP(ref l, ref r, ref tt, 2, 0x33333333);
            func_PERM_OP(ref r, ref l, ref tt, 16, 0x0000ffff);
            func_PERM_OP(ref l, ref r, ref tt, 4, 0x0f0f0f0f); 
        }

        private static void func_HPERM_OP(ref UInt32 a,ref UInt32 t, int n, UInt32 m)
        {
            (t)=((((a)<<(16-(n)))^(a))&(m));
            (a)=(a)^(t)^(t>>(16-(n)));
        }
        ...
        private static void func_c2l_second(byte[] c, ref UInt32 l)
        {
            l = ((UInt32)(c[4]));
            l |= ((UInt32)(c[5])) << 8;
            l |= ((UInt32)(c[6])) << 16;
        ...
        {
            public UInt32[] arrKeys = new UInt32[32];
        }

        public DES_key_schedule m_schedule = new DES_key_schedule();
        public UInt32 enc_mask = 0;
        public UInt32 dec_mask = 0;

        public void init()
        {
            enc_mask = dec_mask = 0xffffffff;
            DES_cblock block = new DES_cblock();
            block.init();
            DES_set_key(block);
        }

        public const UInt32 ITERATIONS = 16;
        public void DES_set_key(DES_cblock key)
        {
            int[] shifts2 = new int[16]{0,0,1,1,1,1,1,1,0,1,1,1,1,1,1,0};
            UInt32 c=0,d=0,t=0,s=0,t2=0;
            //int i = 0;

            func_c2l_first(key.arrBlock, ref c);
            func_c2l_second(key.arrBlock, ref d);

            /* do PC1 in 47 simple operations :-)
            * Thanks to John Fletcher (john_fletcher@lccmail.ocf.llnl.gov)
            * for the inspiration. :-) */
            func_PERM_OP(ref d, ref c, ref t, 4, 0x0f0f0f0f);
            func_HPERM_OP(ref c, ref t, -2, 0xcccc0000);
            func_HPERM_OP(ref d, ref t, -2, 0xcccc0000);
            func_PERM_OP(ref d, ref c, ref t, 1, 0x55555555);
            func_PERM_OP(ref c, ref d, ref t, 8, 0x00ff00ff);
            func_PERM_OP(ref d, ref c, ref t, 1, 0x55555555);
            ...
            for (int i = 0; i < ITERATIONS; i++)
            {
                ...
                m_schedule.arrKeys[2 * i + 0] = func_ROTATE(ref t2, 30) & 0xffffffff;

                t2 = ((s >> 16) | (t & 0xffff0000));
                m_schedule.arrKeys[2 * i + 1] = func_ROTATE(ref t2, 26) & 0xffffffff;
            }
        }

        public static void DES_encrypt1(UInt32[] data, DES_key_schedule ks1, UInt32[,] sp, bool enc)
        {
            UInt32 l=0,r=0,t=0,u=0;
            int i=0;
            ...
            /* shift left by 2 */
            r=func_ROTATE(ref r,29)&0xffffffff;
            l=func_ROTATE(ref l,29)&0xffffffff;

            if (enc)
            {
                for (i = 0; i < 32; i += 8)
                {
                    func_D_ENCRYPT(ref l, ref r, i + 0, ref u, ref t, ks1.arrKeys, sp);//D_ENCRYPT(l,r,i+0); /*  1 */
                    func_D_ENCRYPT(ref r, ref l, i + 2, ref u, ref t, ks1.arrKeys, sp);//D_ENCRYPT(r,l,i+2); /*  2 */
                    func_D_ENCRYPT(ref l, ref r, i + 4, ref u, ref t, ks1.arrKeys, sp);//D_ENCRYPT(l,r,i+4); /*  3 */
                    func_D_ENCRYPT(ref r, ref l, i + 6, ref u, ref t, ks1.arrKeys, sp);//D_ENCRYPT(r,l,i+6); /*  4 */
                }
            }
            else
            {
                for (i = 30; i > 0; i -= 8)
                {
                    func_D_ENCRYPT(ref l, ref r, i - 0, ref u, ref t, ks1.arrKeys, sp);//D_ENCRYPT(l,r,i-0); /* 16 */
                    func_D_ENCRYPT(ref r, ref l, i - 2, ref u, ref t, ks1.arrKeys, sp);//D_ENCRYPT(r,l,i-2); /* 15 */
                    func_D_ENCRYPT(ref l, ref r, i - 4, ref u, ref t, ks1.arrKeys, sp);//D_ENCRYPT(l,r,i-4); /* 14 */
                    func_D_ENCRYPT(ref r, ref l, i - 6, ref u, ref t, ks1.arrKeys, sp);//D_ENCRYPT(r,l,i-6); /* 13 */
                }
            }

            /* rotate and clear the top bits on machines with 8byte longs */
            l=func_ROTATE(ref l,3)&0xffffffff;
            r=func_ROTATE(ref r,3)&0xffffffff;
        ...
        public UInt32 ReadUInt32Encrypt(byte[] Buffer,int index)
        {
            UInt32 result = (UInt32)(Buffer[index] + (Buffer[index + 1] << 8) + (Buffer[index + 2] << 16) + (Buffer[index + 3] << 24));
            return result;
        }

        public void WriteUInt32Encrypt(byte[] Buffer, int index, UInt32 b)
        {
            Buffer[index] = (byte)(b << 24 >> 24);
            Buffer[index + 1] = (byte)(b << 16 >> 24);
            Buffer[index + 2] = (byte)(b << 8 >> 24);
            Buffer[index + 3] = (byte)(b >> 24);
        }

        public static UInt32 func_ROTATE_LEFT(ref UInt32 x, int n)
        {
            return (((x) << (n)) | ((x) >> (32-(n))));
        }
        ...
        public void encdec_des(byte[] data, int index, int nLen, bool enc)
        {
            ...
            while (offset<=nLen-8)
            {
                if ((0x80000000 & (enc ? enc_mask : dec_mask)) > 0)
                {
                    UInt32[] temp = new UInt32[2];
                    temp[0] = ReadUInt32Encrypt(data,index+offset);
                    temp[1] = ReadUInt32Encrypt(data,index+offset+4);

                    DES_encrypt1(temp, m_schedule, MyDES_SPtrans, enc);

                    WriteUInt32Encrypt(data, index + offset, temp[0]);
                    WriteUInt32Encrypt(data, index + offset + 4, temp[1]);
                }

                offset += 8;
                if (enc)
                    enc_mask = func_ROTATE_LEFT(ref enc_mask, 1); 
                else
                    dec_mask = func_ROTATE_LEFT(ref dec_mask, 1); 
            }   
