...
public class AssetsManager
{
    ...
    public static void LoadSceneAsync(string sceneName, LoadSceneMode mode, System.Action call)
    {

#if UNITY_EDITOR
        AssetBundleManager.Instance.LoadScene(sceneName, mode, call);
        return;
#endif
        AssetBundleManager.Instance.LoadSceneAsync(sceneName, mode, call);
    }
