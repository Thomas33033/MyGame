...
public class UnitAttribute{
	...
	public bool alwaysShowOverlay=true;
}
...
public class Unit : MonoBehaviour {
	...
	[HideInInspector] public GamePath path;
	...
	public void UpdateOverlay(){
		...
		if(HPAttribute.HP>=HPAttribute.fullHP && !HPAttribute.alwaysShowOverlay){
			...
			if(HPAttribute.overlayHP!=null) HPAttribute.overlayHP.GetComponent<Renderer>().enabled=false;
			if(HPAttribute.overlayBase!=null) HPAttribute.overlayBase.GetComponent<Renderer>().enabled=false;
		}
		else{
			overlayIsVisible=true;
			if(HPAttribute.overlayHP!=null && HPAttribute.HP>0) HPAttribute.overlayHP.GetComponent<Renderer>().enabled=true;
			else HPAttribute.overlayHP.GetComponent<Renderer>().enabled=false;
			if(HPAttribute.overlayBase!=null) HPAttribute.overlayBase.GetComponent<Renderer>().enabled=true;
		}
	}
