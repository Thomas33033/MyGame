...
namespace UnityEngine.UI
{
    ...
    public abstract class LoopScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        //停止Scroll的事件
        public Action stopScrollCallback;
        private Action _stopScrollCallback = null;
        [SerializeField]
        public float inertiaMaxTime = 1f;//限制惯性持续时间
        ...
        private int m_PrevTotalCount;
        private LoopScrollSendIndexSource dataSource = new LoopScrollSendIndexSource();
        ...
        {
            this.m_PrevTotalCount = this.totalCount;
            this.totalCount = value;
        }

        public void SetLuaScrollCellChangeEvent(LuaFunction luaScrollCellChangeEvent)
        {
            this.dataSource.luaScrollCellChangeEvent = luaScrollCellChangeEvent;
        }

        public void SetScrollCellChangeEvent(Action<Transform, int> ScrollCellChangeEvent)
        {
            this.dataSource.ScrollCellChangeEvent = ScrollCellChangeEvent;
        }
        ...
        {
            Debug.LogError("RefillCellsFromEnd");
        ...
        {            if (prefabSource == null)
            {
                Debug.LogErrorFormat("prefabSource null");
                return null;
            }
        ...
        {
            base.OnDestroy();
            ResourceManager.Instance.DetelePool(this.prefabSource.prefabGameobj);
        }
