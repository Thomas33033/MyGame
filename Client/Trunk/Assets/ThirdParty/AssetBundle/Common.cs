...
namespace Cherry.AssetBundlePacker
{
    public static class Common
    {
        ...
        /// 项目资源根路径名称
        /// </summary>
        public const string PROJECT_ASSET_ROOT_NAME = "Assets/Res";

        /// <summary>
        ///   常驻根路径
        ///   此路径主要存放所有游戏中所需使用的AssetBundle、其它配置文件
        /// </summary>
        public static readonly string PATH = Application.streamingAssetsPath + "/" + ROOT_FOLDER_NAME;

        /// <summary>
        ///   初始路径
        ///   此路径为安装包中的AssetBundlePacker所携带的资源和配置文件路径
        /// </summary>
        public static readonly string INITIAL_PATH = Application.streamingAssetsPath + "/" + ROOT_FOLDER_NAME;
